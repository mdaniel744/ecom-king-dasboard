...
const demoInquiry: Inquiry = {
  ...
  delivery_address: {
    full_name: "Amina Bello",
    company: "Bello Retail Ltd",
    address_line_1: "7 Warehouse Road",
    city: "Apapa",
    state: "Lagos",
    postal_code: "102272",
    country: "Nigeria",
  ...
  product_snapshot: {
    ...
    url: "https://example-store.com/products/classic-hoodie-small-black",
    image: demoProducts[0].images[0] ?? null,
    listed_price: demoProducts[0].price,
    currency: demoProducts[0].currency,
    attributes: {
      ...demoProducts[0].attributes,
      Embroidery: "Company logo on chest",
    },
  },
  form_data: {
    preferred_delivery_date: "2026-02-15",
  ...
  line_items: [
    {
      ...
      product_url: "https://example-store.com/products/classic-hoodie-small-black",
      sku: demoProducts[0].sku,
      attributes: demoProducts[0].attributes,
      line_subtotal: 118,
      line_tax_amount: 0,
      line_total: 118,
      condition: "New",
    ...
    },
    {
      ...
      quantity: 1,
      product_url: "https://example-store.com/products/classic-hoodie-small-white",
      sku: demoProducts[1].sku,
      attributes: demoProducts[1].attributes,
      line_subtotal: 64,
      line_tax_amount: 0,
      line_total: 64,
      condition: "New",
  ...
  line_items: [
    {
      ...
      quantity: 1,
      product_url: "https://example-store.com/products/classic-hoodie-small-navy",
      sku: demoProducts[2].sku,
      attributes: demoProducts[2].attributes,
      line_subtotal: 69,
      line_tax_amount: 0,
      line_total: 69,
      condition: "New",
...
function localDemoInsertDefaults(table: string): Record<string, unknown> {
  if (table === "checkout_orders") {
    return {
      order_number: `ORD-DEMO-${String(Date.now()).slice(-8)}`,
      customer_phone: null,
      customer_details: {},
      line_items: [],
  ...
  if (table === "inquiries") {
    return {
      inquiry_number: `ENQ-DEMO-${String(Date.now()).slice(-8)}`,
      product_id: null,
      customer_name: null,
      customer_email: null,
      customer_phone: null,
